/********************************************************************************
*nRF24L01+ STM32F1 Library written By LonelyWolf (https://github.com/LonelyWolf)*
*                       Ported for c++ By Hamed Tahery                          *
*                             Hamed.t@live.com                                  *
*********************************************************************************
...
void nRF24_GPIO_Init(void) 
{
    ...
    // Enable the nRF24L01 GPIO peripherals
		...
		#elif nRF24_SPI_PORT == 2
		// SPI2
		RCC_APB2PeriphClockCmd(RCC_APB2Periph_GPIOB,ENABLE);
		RCC_APB1PeriphClockCmd(RCC_APB1Periph_SPI2,ENABLE);
		#elif nRF24_SPI_PORT == 3
		// SPI3
		...
		// Configure CSN pin as output with Push-
...
// input: mode - new state of power mode, one of nRF24_PWR_xx values
void Nrf24::SetPowerMode(uint8_t mode) 
{
	uint8_t reg;
...
// input: mode - operational mode, one of nRF24_MODE_xx values
void Nrf24::SetOperationalMode(uint8_t mode) 
{
	uint8_t reg;
...
// input: scheme - CRC scheme, one of nRF24_CRC_xx values
// note: transceiver will forcibly turn on the CRC in case if auto acknowledgment
//       enabled for at least one RX pipe
void Nrf24::SetCRCScheme(uint8_t scheme) 
{
	uint8_t reg;
...
// input: channel - radio frequency channel, value from 0 to 127
...
// input: ard - auto retransmit delay, one of nRF24_ARD_xx values
//   arc - count of auto retransmits, value form 0 to 15
// note: zero arc value means that the automatic retransmission disabled
void Nrf24::SetAutoRetr(uint8_t ard, uint8_t arc) 
{
...
// input:addr_width - RX/TX address field width, value from 3 to 5
...
void Nrf24::SetAddr(uint8_t pipe, const uint8_t *addr) 
{
	uint8_t addr_width;
	// RX_ADDR_Px register
	switch (pipe) 
...
// input: tx_pwr - RF output power, one of nRF24_TXPWR_xx values
void Nrf24::SetTXPower(uint8_t tx_pwr) 
{
	uint8_t reg;
...
// input:  data_rate - data rate, one of nRF24_DR_xx values
void Nrf24::SetDataRate(uint8_t data_rate) 
{
	uint8_t reg;
...
void Nrf24::SetRXPipe(uint8_t pipe, uint8_t aa_state, uint8_t payload_len) 
{
	uint8_t reg;
...
// input: PIPE - number of RX pipe, value from 0 to 5
...
// input: pipe - number of the RX pipe, value from 0 to 5
void Nrf24::EnableAA(uint8_t pipe) 
{
	uint8_t reg;
...
// input:pipe - number of the RX pipe, value from 0 to 5, any other value will disable AA for all RX pipes
void Nrf24::DisableAA(uint8_t pipe) 
{
	uint8_t reg;
	if (pipe > 5) 
	{
...
uint8_t  Nrf24::GetRetransmitCounters(void) 
{
	return (nRF24_ReadReg(nRF24_REG_OBSERVE_TX));
}
//--------------------------------------------------------------------
// Reset packet lost counter (PLOS_CNT bits in OBSERVER_TX re
void Nrf24::ResetPLOS(void) 
{
	uint8_t reg;
...
//--------------------------------------------------------------------
// Write TX payload
// input:pBuf - pointer to the buffer with payload data
...
nRF24_RXResult Nrf24::ReadPayload(uint8_t *pBuf, uint8_t *length) 
{
	uint8_t pipe;
...
//--------------------------------------------------------------------
nRF24_TXResult Nrf24::TransmitPacket(uint8_t *pBuf, uint8_t length) 
{
	uint8_t status;
...
//--------------------------------------------------------------------
uint8_t Nrf24::GetRFChannel (void)
{
